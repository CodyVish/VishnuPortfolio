...
export default function Contact() {
  return (
    <div className="flex flex-col justify-center items-center h-screen text-gray-400 px-4">
      ...
      <div className="flex flex-wrap justify-center gap-6 sm:gap-8 text-3xl sm:text-4xl">
        {[
          ...
          <motion.a
            ...
            className={`inline-flex items-center justify-center min-w-[48px] min-h-[48px] transition duration-300 cursor-pointer ${item.color}`}
          >
            {item.icon}
          </motion.a>
        ))}
